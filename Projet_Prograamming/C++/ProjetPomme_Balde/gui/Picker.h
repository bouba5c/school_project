...
/**
 * @class Picker
 * @brief Represents a tile of type "Picker" with different properties such as value , color and name.
 */
...
public:
     ...
     * @details The name of the Picker tile is represented as "PI"
     * @return The name of the Picker tile.
     */
    std::string getName() override{

        return " PI "; //ansi color orange
    }
    /**
