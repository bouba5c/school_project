...
/**
 * @class Model
 * @brief Represents the game's logic
...
public:
     ...
     */
    Model(int scorePlayer1,int scorePlayer2);
     ...
     * @return a shared pointer of player representing the players.

     */
    std::vector<std::shared_ptr<Player>> getPlayers();
    /**
     * @brief reset all player's bag capactity used function for console only
     */
...
private:
    ...
    /**
     * \brief current player of the game
     */
    int curentPlayer;
    /**
     * \brief board of the game containg tiles
     */
    std::unique_ptr<Board> board;
    /**
     * \brief deck of the game containing 25 cards
     */
    Deck deck;
    /**
    ...
    State state;
    /**
     * \brief state of the gameMode only in console
     */
    State gameMode;
    /**
     * \brief picker tile
